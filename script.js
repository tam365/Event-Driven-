...
//Toggle button functions that enables and disaples each button
function start()
{
    document.getElementById("startbutton").disabled =true; //enabling start button
    document.getElementById("stopbutton").disabled=false;//disabling stop button

}

function stop()
{
    document.getElementById("startbutton").disabled =false;//disabling start button
    document.getElementById("stopbutton").disabled=true;//enabling stop button
